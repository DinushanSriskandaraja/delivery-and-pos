-- ============================================================================
-- SAFE DATABASE RESET - Handles existing auth.users properly
-- ============================================================================
-- This version won't cause duplicate key errors
-- ============================================================================

-- Step 1: Temporarily disable the trigger to prevent issues during reset
DROP TRIGGER IF EXISTS on_auth_user_created ON auth.users;

-- Step 2: Drop all tables and objects
...
-- Step 3: Delete storage objects and bucket
...
-- Step 5: Populate users table with existing auth users (prevents duplicates!)
...
SELECT 
  ...
  COALESCE(raw_user_meta_data->>'role', 'consumer')
FROM auth.users
ON CONFLICT (id) DO NOTHING;

-- Step 6: Create all other tables
CREATE TABLE shops (
...
-- Step 11: Create trigger for NEW users only (won't affect existing users)
...
-- Done!
SELECT 'Database reset complete! All existing auth users have been migrated.' as status;
